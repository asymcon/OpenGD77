...
void settingsRestoreDefaultSettings(void)
{
	...
	nonVolatileSettings.txPowerLevel=9;// 1W Power level in fw_trx.c must match 1W level case
	...
	nonVolatileSettings.vfoAScanHigh=14800000;						//High Frequency limit for VFO A Scanning
