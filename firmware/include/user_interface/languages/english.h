...
.firmware_info			= "Firmware", // MaxLen: 16
.options				= "Options", // MaxLen: 16
.display_options			= "Display", // MaxLen: 16
.sound_options				= "Sound", // MaxLen: 16
.channel_details			= "Channel", // MaxLen: 16
...
.power_off				= "Powering Off...", // MaxLen: 16
...
.filter					= "Monitor", // MaxLen: 7 (with ':' + settings: .none, "CC", "CC,TS", "CC,TS,TG")
...
.vfoToNewChannel		= "Add New Channel", // MaxLen: 16
...
.brightness_off				= "Minimum", // MaxLen: 16 (with ':' + 0..100 + '%')
.contrast				= "Contrast", // MaxLen: 16 (with ':' + 12..30)
.colour_invert				= "On", // MaxLen: 16
.colour_normal				= "Off", // MaxLen: 16
...
.display_background_colour = "Invert", // Maxlen 16 (with : + .colour_normal or .colour_invert)
